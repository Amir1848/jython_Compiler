...
public class MainParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, CLASSNAME=41, BOOL=42, INTEGER=43, STRING=44, FLOAT=45, 
		TYPE=46, ID=47;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, "CLASSNAME", "BOOL", "INTEGER", "STRING", 
			"FLOAT", "TYPE", "ID"
		};
	}
	...
	public final ArgsContext args() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__2) | (1L << T__24) | (1L << BOOL) | (1L << INTEGER) | (1L << STRING) | (1L << FLOAT) | (1L << TYPE) | (1L << ID))) != 0)) {
				{
				setState(357);
				explist();
				}
